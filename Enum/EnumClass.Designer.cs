...
namespace EnumSpace
{
    partial class EnumClass
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.scan = new Enum.OwerControl.TTGroupBox();
            this.btnPT = new Enum.OwerControl.TTButton();
            this.btnAppUp = new Enum.OwerControl.TTButton();
            this.btnAppDown = new Enum.OwerControl.TTButton();
            this.btnAppTop = new Enum.OwerControl.TTButton();
            this.btnWebUp = new Enum.OwerControl.TTButton();
            this.btnWebDown = new Enum.OwerControl.TTButton();
            this.btnWebTop = new Enum.OwerControl.TTButton();
            this.btnWebCreate = new Enum.OwerControl.TTButton();
            this.webbtn = new Enum.OwerControl.TTTextBox();
            this.webwldz = new Enum.OwerControl.TTLabel();
            this.webanmc = new Enum.OwerControl.TTLabel();
            this.appurl = new Enum.OwerControl.TTTextBox();
            this.btnWebClear = new Enum.OwerControl.TTButton();
            this.btnAppClear = new Enum.OwerControl.TTButton();
            this.webllq = new Enum.OwerControl.TTTextBox();
            this.btnAppCreate = new Enum.OwerControl.TTButton();
            this.webllqmc = new Enum.OwerControl.TTLabel();
            this.appanmc = new Enum.OwerControl.TTLabel();
            this.weburl = new Enum.OwerControl.TTTextBox();
            this.appname = new Enum.OwerControl.TTTextBox();
            this.webwz = new Enum.OwerControl.TTLabel();
            this.btnClose = new Enum.OwerControl.TTButton();
            this.appan = new Enum.OwerControl.TTGroupBox();
            this.panApp = new Enum.OwerControl.TTPanel();
            this.AppSB = new Enum.OwerControl.TTVScrollBar();
            this.hf = new Enum.OwerControl.TTButton();
            this.sc = new Enum.OwerControl.TTButton();
            this.ycxs = new Enum.OwerControl.TTButton();
            this.weban = new Enum.OwerControl.TTGroupBox();
            this.panWeb = new Enum.OwerControl.TTPanel();
            this.WebSB = new Enum.OwerControl.TTVScrollBar();
            this.hfan = new Enum.OwerControl.TTGroupBox();
            this.panHF = new Enum.OwerControl.TTPanel();
            this.HfSB = new Enum.OwerControl.TTVScrollBar();
